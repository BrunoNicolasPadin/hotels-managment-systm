            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Edit lov</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if ($errors->any())
                ...
                @endforeach
            @endif
            <form action="{{ route('lovs.update', $lov->id) }}" method="post">
                @csrf
                @method('PUT')
